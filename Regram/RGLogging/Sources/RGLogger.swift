...
private var sharedLogger: RGLogger?
...
public class RGLogger {
    ...
    public static let rgLogsPath = "/logs/app-logs-sg"
    
    public var logToFile: Bool = true
    public var logToConsole: Bool = true
    public var redactSensitiveData: Bool = true
    
    public static func setSharedLogger(_ logger: RGLogger) {
        sharedLogger = logger
    }
    
    public static var shared: RGLogger {
        if let sharedLogger = sharedLogger {
            ...
            guard Bundle.main.bundleIdentifier != nil else {
                ...
                return RGLogger(rootPath: "", basePath: "")
            }
