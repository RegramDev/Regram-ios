...
private final class RGOutgoingTranslationLanguageSelectionArguments {
...
private enum RGOutgoingTranslationLanguageSelectionSection: Int32 {
    case languages
}

private enum RGOutgoingTranslationLanguageSelectionEntry: ItemListNodeEntry {
    case language(Int32, PresentationTheme, String, String, Bool, String)
    
    var section: ItemListSectionId {
        return RGOutgoingTranslationLanguageSelectionSection.languages.rawValue
    }
    ...
    static func ==(lhs: RGOutgoingTranslationLanguageSelectionEntry, rhs: RGOutgoingTranslationLanguageSelectionEntry) -> Bool {
        switch lhs {
    ...
    func item(presentationData: ItemListPresentationData, arguments: Any) -> ListViewItem {
        let arguments = arguments as! RGOutgoingTranslationLanguageSelectionArguments
        switch self {
...
private func rgOutgoingTranslationLanguageSelectionEntries(theme: PresentationTheme, selectedLanguage: String?) -> [RGOutgoingTranslationLanguageSelectionEntry] {
    let enLocale = Locale(identifier: "en")
    var entries: [RGOutgoingTranslationLanguageSelectionEntry] = []
...
func rgOutgoingTranslationLanguageSelectionController(context: AccountContext, selectedLanguage: String?, completion: @escaping (String) -> Void) -> ViewController {
    var dismissImpl: (() -> Void)?
    let arguments = RGOutgoingTranslationLanguageSelectionArguments(selectLanguage: { code in
        completion(code)
        dismissImpl?()
    })
    ...
    |> map { presentationData -> (ItemListControllerState, (ItemListNodeState, Any)) in
        ...
        let listState = ItemListNodeState(presentationData: ItemListPresentationData(presentationData), entries: rgOutgoingTranslationLanguageSelectionEntries(theme: presentationData.theme, selectedLanguage: selectedLanguage), style: .blocks, animateChanges: false)
