...
public class RGItemListCounter {
...
public protocol RGItemListSection: Equatable {
    var rawValue: Int32 { get }
}

public final class RGItemListArguments<BoolSetting: Hashable, SliderSetting: Hashable, OneFromManySetting: Hashable, DisclosureLink: Hashable, ActionType: Hashable> {
...
public enum RGItemListUIEntry<Section: RGItemListSection, BoolSetting: Hashable, SliderSetting: Hashable, OneFromManySetting: Hashable, DisclosureLink: Hashable, ActionType: Hashable>: ItemListNodeEntry {
    ...
    public static func <(lhs: RGItemListUIEntry, rhs: RGItemListUIEntry) -> Bool {
    ...
    public func item(presentationData: ItemListPresentationData, arguments: Any) -> ListViewItem {
        let arguments = arguments as! RGItemListArguments<BoolSetting, SliderSetting, OneFromManySetting, DisclosureLink, ActionType>
        switch self {
        ...
        case let .oneFromManySelector(_, _, settingName, text, value, enabled):
            return ItemListDisclosureItem(presentationData: presentationData, systemStyle: .glass, title: text, enabled: enabled, label: value, rgLabelMaximumNumberOfLines: 2, sectionId: self.section, style: .blocks, action: {
