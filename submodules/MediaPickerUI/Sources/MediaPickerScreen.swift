...
public final class MediaPickerScreenImpl: ViewController, MediaPickerScreen, AttachmentContainable {
    ...
    private class Node: ViewControllerTracingNode, ASGestureRecognizerDelegate {
        ...
        override func didLoad() {
            ...
            if useLegacyCamera && !RGSimpleSettings.shared.disableGalleryCamera {
                let enableAnimations = self.controller?.context.sharedContext.energyUsageSettings.fullTranslucency ?? true && !RGSimpleSettings.shared.disableGalleryCameraPreview
        ...
        func updateIsCameraActive() {
            ...
            if let cameraView = self.cameraView {
                if isCameraActive {
                    if !RGSimpleSettings.shared.disableGalleryCameraPreview {
