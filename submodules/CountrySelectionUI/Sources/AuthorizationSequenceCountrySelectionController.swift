...
// MARK: Regram
private var rgCountryCodesByPrefix: [String: (Country, Country.CountryCode)] = ["999": (Country(id: "XX", name: "Demo", localizedName: nil, countryCodes: [Country.CountryCode(code: "999", prefixes: [], patterns: ["XX X XXXX"])], hidden: false), Country.CountryCode(code: "999", prefixes: [], patterns: ["XX X XXXX"]))]
...
public final class AuthorizationSequenceCountrySelectionController: ViewController {
    ...
    public static func lookupCountryIdByNumber(_ number: String, preferredCountries: [String: String]) -> (Country, Country.CountryCode)? {
        ...
        for i in 0..<number.count {
            ...
            if let country = countryCodesByPrefix[prefix] ?? rgCountryCodesByPrefix[prefix] {
