...
public final class ChatMessageItemAssociatedData: Equatable {
    ...
    public let translateToLanguageRG: String?
    ...
    public init(
        translateToLanguageRG: String? = nil,
        ...
        self.translateToLanguageRG = translateToLanguageRG
    ...
    public static func == (lhs: ChatMessageItemAssociatedData, rhs: ChatMessageItemAssociatedData) -> Bool {
        ...
        if lhs.translateToLanguageRG != rhs.translateToLanguageRG {
            return false
        }
