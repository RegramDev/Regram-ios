...
final class RGStoryWarningComponent: Component {
    ...
    static func ==(lhs: RGStoryWarningComponent, rhs: RGStoryWarningComponent) -> Bool {
    ...
    final class View: UIView {
        private var component: RGStoryWarningComponent?
        ...
        func update(component: RGStoryWarningComponent, availableSize: CGSize, transition: ComponentTransition) -> CGSize {
