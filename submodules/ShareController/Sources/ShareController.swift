...
public final class ShareController: ViewController {
    ...
    public convenience init(context: AccountContext, subject: ShareControllerSubject, presetText: String? = nil, preferredAction: ShareControllerPreferredAction = .default, showInChat: ((Message) -> Void)? = nil, fromForeignApp: Bool = false, segmentedValues: [ShareControllerSegmentedValue]? = nil, externalShare: Bool = true, immediateExternalShare: Bool = false, immediateExternalShareOverridingRGBehaviour: Bool? = nil, switchableAccounts: [AccountWithInfo] = [], immediatePeerId: PeerId? = nil, updatedPresentationData: (initial: PresentationData, signal: Signal<PresentationData, NoError>)? = nil, forceTheme: PresentationTheme? = nil, forcedActionTitle: String? = nil, shareAsLink: Bool = false, collectibleItemInfo: TelegramCollectibleItemInfo? = nil) {
        var immediateExternalShare = immediateExternalShare
        if RGSimpleSettings.shared.forceSystemSharing {
            immediateExternalShare = true
        }
        if let immediateExternalShareOverridingRGBehaviour = immediateExternalShareOverridingRGBehaviour {
            immediateExternalShare = immediateExternalShareOverridingRGBehaviour
        }
        self.init(
