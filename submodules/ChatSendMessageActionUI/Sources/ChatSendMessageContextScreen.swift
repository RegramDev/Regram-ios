...
final class ChatSendMessageContextScreenComponent: Component {
    ...
    let rgTranslationContext: (outgoingMessageTranslateToLang: String?, translate: (() -> Void)?, changeTranslationLanguage: (() -> ())?)
    ...
    // MARK: Regram
    init(
        rgTranslationContext: (outgoingMessageTranslateToLang: String?, translate: (() -> Void)?, changeTranslationLanguage: (() -> ())?) = (outgoingMessageTranslateToLang: nil, translate: nil, changeTranslationLanguage: nil),
        ...
        self.rgTranslationContext = rgTranslationContext
    ...
    final class View: UIView {
        ...
        func update(component: ChatSendMessageContextScreenComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<EnvironmentType>, transition: ComponentTransition) -> CGSize {
            ...
            // MARK: Regram
            if !isSecret {
                if let outgoingMessageTranslateToLang = component.rgTranslationContext.outgoingMessageTranslateToLang {
                    ...
                    items.append(.action(ContextMenuActionItem(
                        ...
                        icon: { theme in
                            ...
                            component.rgTranslationContext.translate?()
                            self.environment?.controller()?.dismiss()
                        }
                    )))
                    ...
                    items.append(.action(ContextMenuActionItem(
                        ...
                        icon: { theme in
                            ...
                            self.environment?.controller()?.dismiss()
                            component.rgTranslationContext.changeTranslationLanguage?()
                        }
                    )))
