...
final class PasscodeEntryControllerNode: ASDisplayNode {
    ...
    func initialAppearance(fadeIn: Bool = false) {
        ...
        self.titleNode.setAttributedText(NSAttributedString(string: self.strings.EnterPasscode_EnterPasscode.replacingOccurrences(of: "Telegram", with: "Regram") /* MARK: Regram */, font: titleFont, textColor: .white), animation: .none)
    }
